...
def main():
    ...
    # ga_optimizer = GeneticAlgorithm(TAM_POP=400, recortes_disponiveis=recortes_disponiveis,
    #                                 sheet_width=sheet_width, sheet_height=sheet_height, numero_geracoes=10000)
    ...
    ps_optimizer = ParticleSwarm(num_particles=100, num_iterations=1000, dim=len(recortes_disponiveis),
